...
bool BST::loadData() {
    ...
    if (!file) {
        cout << "Error occured. File did not open.\n";
        return false;
    }
    file.close();
}
...
int main()
{
    ...
    //menu loop that will iterate until user enters 9
    while (choice != 9) {
        ...
        case 3:
            cout << "Please enter the course number you would like to know about: ";
            cin >> courseNum;
        ...
        case 9:
            ...
            //for invalid input
        default:
            cout << choice << " is not a valid option. Please enter a valid choice.\n";
        }
    }
    return 0;
}
